                ...
                {howToContent.map((item, idx) => (
                  <li key={idx}>
                    <Tab
                      className={({ selected }) =>
                        useClassNames(
                          'flex items-center min-w-[18rem] pl-16 py-6 pr-14 rounded-[5rem] text-lg text-red-500 font-medium leading-none transition ease-in-out duration-300 overflow-hidden counter-item hover:shadow-glow-md hover:scale-105 active:bg-black/10 focus:shadow-red-600/40',
